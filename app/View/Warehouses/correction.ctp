<div class="row">
                            <div class="col-md-12">
                                <!-- DATA TABLE -->
                                <h3 class="title m-b-35 text-center">La correction du stock</h3>
                                        ...
                                        <div class="table-responsive table-responsive-data2">
                                            <table class="table table-striped table-bordered">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <th class="text-center" colspan="3">Correction</th>
                                                        <th class="text-center" colspan="3">Disponible</th>
                                                    </tr>
                                                    <tr>
                                                        <th>Date</th>
                                                        <th >Produit</th>
                                                ...
                                                <?php foreach ($stock_depot as $stock_depot): current($stock_depot);?>
                                                    <tr class="tr-shadow">
                                                        ...
                                                        <td class="text-center">
                                                            <?php if($stock_depot['Warehouse']['mvm']==true) {?>
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-12 col-md-12">
                                                                            <p class="text-center" style="margin-top:100px">
                                                                                ...
                                                                                <h4 class="text-center">AUCUNE CORRECTION .</h4>
                                                                                <br><br><br><br><br><br>
                                                                            </p>
                                                    </div>
                                                </div>
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="row">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-12">
                                                                <div class="form-group">
                                                                    ...
                                                                    <?php
                                                                        echo $this->Form->input('datep',array('id' => 'datepicker','class'=>'form-control','label'=>false,'value'=>$datep,'readonly'=>true));
                                                                    ?>
                                                                </div>
                                                            </div> 
                                                        </div>
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    <label class="control-label mb-1">Augmentation</label>
                                                                    <?php
                                                                        echo $this->Form->checkbox('aug');
                                                                    ?>
                                                                </div>
                                                            </div> 
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    <label class="control-label mb-1">Reduction</label>
                                                                    <?php
                                                                        echo $this->Form->checkbox('dim');
                                                                    ?>
                                                                </div>
                                                            </div>
                                                        </div>
                                                ...
                                                <div class="text-center">
                                                    <button id="submit" name="submit" type="submit" class="btn btn-outline-success">Correction</button>
